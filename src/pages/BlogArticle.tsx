      ...
      <section className="py-12 px-4 bg-gray-50 border-t border-gray-100">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div>
              <h3 className="text-sm font-bold text-gray-800 uppercase tracking-wider mb-3">Quick Links</h3>
              <ul className="space-y-1">
                <li><Link to="/book-demo" className="text-gray-500 text-sm hover:text-blue-600 transition-colors">Book a Demo</Link></li>
                <li><Link to="/pricing" className="text-gray-500 text-sm hover:text-blue-600 transition-colors">Pricing Plans</Link></li>
                <li><Link to="/case-studies" className="text-gray-500 text-sm hover:text-blue-600 transition-colors">Case Studies</Link></li>
                <li><Link to="/community" className="text-gray-500 text-sm hover:text-blue-600 transition-colors">Join Community</Link></li>
                <li><Link to="/contact" className="text-gray-500 text-sm hover:text-blue-600 transition-colors">Contact Us</Link></li>
              </ul>
            </div>
          </div>
        </div>
